...
<form action="cadastro.php" method="post">
    ...
    <div id="sabor-embalagem-container">
        <div id="sabor-container">
    ...
    <div id="tipo_radio">
        <?php 
            ...
            while($row = $result->fetch_assoc()){   
                echo "<input type='radio' name='picole' value='{$row['id']}' id='picole_{$row['id']}' required>";
                echo "<label for='picole_{$row['id']}'>{$row['nome']}</label>";
            }
        ?>
    </div>
    ...
    <div id="button-container">
        ...
        <button type="submit" name="acao" id="btn-exibir" value="exibir" formnovalidate>Ver todos Picolés</button>
...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if ($_POST["acao"] === "cadastrar"){
        ...
        if ($stmt->execute()) {
            echo "<p>Picolé cadastrado com sucesso!</p>";
        } else {
